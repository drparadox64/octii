import { MAP_SIZE } from "https://cdn.jsdelivr.net/gh/drparadox64/octii@latest/data.js";

export async function tmx2map(fn) {
    const xmlfile = await fetch("https://cdn.jsdelivr.net/gh/drparadox64/octii@latest/maps/"+fn+".tmx");
